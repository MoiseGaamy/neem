import { StyleSheet, Text, View,TouchableOpacity,Button,Alert,TextInput ,useWindowDimensions, KeyboardAvoidingView} from 'react-native'
    ...
    <KeyboardAvoidingView behavior={`${padding}`} style={{flex:1,minHeight:widowWith}}>
        <View style={styles.container}>
          ...
          <View style={styles.secondContainer}>
            <View style={{ paddingHorizontal: 50, flex: 0.7,justifyContent:"space-around"}}>
              <View style={{width:320,height:50}}>
                  <Text  style={{fontSize:18,fontFamily:'inconsolata'}}>Goal Name</Text>
                  <TouchableOpacity style={{height:35,borderRadius:30,backgroundColor:"#31efea",justifyContent:"center",alignItems:"center"}}><TextInput value={name} style={{color:"#000"}} onChangeText={(text)=>setName(text)} placeholder='goal name'/></TouchableOpacity>
            </View>
            <View>
                <Text style={{fontSize:18,fontFamily:'inconsolata',marginTop:20}}>Goal Target</Text>
                <Picker
                  style={{color:'#14A5A1'}}
                    ...
                    <Picker.Item label="Trip" value="https://images.unsplash.com/photo-1512289984044-071903207f5e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" />
                    <Picker.Item label="Debt" value="https://images.unsplash.com/photo-1634128222187-18eababc763d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" />
                    <Picker.Item label="Rental" value="https://images.unsplash.com/photo-1490197415175-074fd86b1fcc?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=874&q=80" />
                  </Picker>
              </View>
          ...
          {show && (
            ...
            <View style={styles.thirdContainer}>
              <View style={{flex:0.5,justifyContent:"space-evenly",alignItems:"center"}}>
                <Text style={{ color: "#fff", fontSize: 17, fontFamily: "inconsolata" }}> You will Save  <Text style={{fontSize:19}}>{amount}.00 Ghs</Text> by</Text>
                <Text style={{ fontSize: 30, color: "#fff" }}></Text>
            </View>
            <TouchableOpacity onPress={handleSubmit} style={{flex:0.3,flexDirection:"row", width:350,height:50,backgroundColor:"#fff",borderRadius:20,alignItems:"center",justifyContent:"center"}}><MaterialCommunityIcons name="plus-thick" size={15} color="black" /><Text style={{paddingHorizontal:10}}>Create a goal</Text></TouchableOpacity>
        </View>
        </View>
        </View>
